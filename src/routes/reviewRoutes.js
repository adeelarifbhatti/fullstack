...
router.route('/:id')
    ...
    .delete(authController.secure,authController.limitedTo('student'),reviewController.deleteReview) 
    .patch(authController.secure,authController.limitedTo('student'),reviewController.updateReview);
